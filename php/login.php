...
class OneFileLoginApplication
{
    ...
    private function showPageLoggedIn()
    {
        ...
        echo "<script language='JavaScript' src='js/services/login.js' type='text/javascript'/>";
    ...
    private function showPageRegistration()
    {
        ...
        echo '<input id="login_input_email" type="email" name="user_email" placeholder="Email" required />';
        echo '</br>';
        //echo '<label for="login_input_password_new">Password (min. 6 characters)</label>';
        echo '<input id="login_input_password_new" class="login_input" type="password" name="user_password_new" pattern=".{6,}" placeholder="Password" required autocomplete="off" />';
        //echo '<label for="login_input_password_repeat">Repeat password</label>';
        echo '<input id="login_input_password_repeat" class="login_input" type="password" name="user_password_repeat" pattern=".{6,}" placeholder="Repeat" required autocomplete="off" />';
        echo '</br>';
